...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/orderitems/pay" method="post">
    <table width="80%">
        <tr>
        ...
        <tr>
            ...
            <td><img src="${pageContext.request.contextPath}/bank_img/zx.bmp"></td>
            <td><INPUT TYPE="radio" NAME="pd_FrpId" value="ICBC-NET">工商银行</td>
            <td><img src="${pageContext.request.contextPath}/bank_img/gf.bmp"></td>
            <td><INPUT TYPE="radio" NAME="pd_FrpId" value="ABC-NET">农业银行</td>
            <td><img src="${pageContext.request.contextPath}/bank_img/nanjing.bmp"></td>
        </tr>
        <tr>
            <td><INPUT TYPE="radio" NAME="pd_FrpId" value="CMBC-NET">中国民生银行总行</td>
            <td><img src="${pageContext.request.contextPath}/bank_img/zheshang.bmp"></td>
            <td><INPUT TYPE="radio" NAME="pd_FrpId" value="CEB-NET" >光大银行 </td>
            <td><img src="${pageContext.request.contextPath}/bank_img/guangda.bmp"></td>
            <td><INPUT TYPE="radio" NAME="pd_FrpId" value="BOCO-NET">交通银行</td>
            <td><img src="${pageContext.request.contextPath}/bank_img/bj.bmp"></td>
        </tr>
        <tr>
            ...
            <td><img src="${pageContext.request.contextPath}/bank_img/shpd.bmp"></td>
        </tr>
        <tr>
            <td><INPUT TYPE="radio" NAME="pd_FrpId" value="ECITIC-NET">中信银行</td>
            <td><img src="${pageContext.request.contextPath}/bank_img/zx.bmp"></td>
            <td><INPUT TYPE="radio" NAME="pd_FrpId" value="SDB-NET">深圳发展银行</td>
            <td><img src="${pageContext.request.contextPath}/bank_img/sfz.bmp"></td>
