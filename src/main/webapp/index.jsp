...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-3" style="padding-top:20px">
            <ol class="list-inline">
                <li><a href="${pageContext.request.contextPath}/view/login">登录</a></li>
                <li><a href="${pageContext.request.contextPath}/view/register">注册</a></li>
                <li><a href="${pageContext.request.contextPath}/view/cart">购物车</a></li>
            </ol>
        </div>
    </div>
    <!--
    ...
    <div class="container-fluid">
        tomcat:9001 ${pageContext.request.session.id}
    </div>
    <!--
        作者：ci2713@163.com
        时间：2015-12-30
